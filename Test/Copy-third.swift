...
class CopyThirdViewController: UIViewController, CLLocationManagerDelegate, UNUserNotificationCenterDelegate {
...
//        scheduleNotification()
        ...
        inputDestination.frame = CGRect(x: 10, y: 125, width: 400, height: 50)
        self.view.addSubview(inputDestination)
        
        
        inputRadius.textColor   =   .black
        inputRadius.text = String(self.radius)
        inputRadius.frame = CGRect(x: 10, y: 200, width: 400, height: 50)
